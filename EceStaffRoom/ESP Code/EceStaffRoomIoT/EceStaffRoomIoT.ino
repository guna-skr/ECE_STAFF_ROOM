/*
 * Project Title: Wi-Fi Controlled Relay Switches
 * Author: Abdul Muhsin A
 * Company: Femto3D
 * Contact: support@femto3d.com
 * Description: 
 * This project allows control of up to 8 relay switches over Wi-Fi. 
 * Each switch can be toggled manually using physical push buttons, 
 * and the state of each relay can also be controlled remotely via Wi-Fi.
 * The device supports provisioning for Wi-Fi connectivity and includes 
 * a simple interface for interaction with connected devices.
 * 
 * The code uses the RMaker library for device registration and 
 * communication. The relays are connected to specific GPIO pins, and 
 * the push buttons are configured with pull-up resistors to ensure 
 * reliable state detection. The system handles state updates and 
 * provides feedback through the serial monitor.
 * 
 * Visit femto3d.com to reach out for engineering projects and 3D printing 
...
const char *service_name = "AbdulMuhsin"; // Service name for the device
const char *pop = "23012005"; // Provisioning password

// define the Device Names
char deviceName_1[] = "HOD FAN";
char deviceName_2[] = "HOD LIGHT";
char deviceName_3[] = "KP";
char deviceName_4[] = "KS";
char deviceName_5[] = "AS";
char deviceName_6[] = "SM";
char deviceName_7[] = "KR";
char deviceName_8[] = "LIGHT 2";

// define the GPIO connected with Relays and switcheš
...
// Switch State
bool SwitchState_1 = LOW; // Define the initial state for switch 1
bool SwitchState_2 = LOW; // Define the initial state for switch 2
bool SwitchState_3 = LOW; // Define the initial state for switch 3
bool SwitchState_4 = LOW; // Define the initial state for switch 4
bool SwitchState_5 = LOW; // Define the initial state for switch 5
bool SwitchState_6 = LOW; // Define the initial state for switch 6
bool SwitchState_7 = LOW; // Define the initial state for switch 7
bool SwitchState_8 = LOW; // Define the initial state for switch 8
...
void setup()
{
    ...
    Node my_node;    
    my_node = RMaker.initNode("ECE STAFFROOM CONTROLS");
